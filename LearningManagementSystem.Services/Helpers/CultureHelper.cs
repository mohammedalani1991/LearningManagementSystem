    ...
    public class CultureHelper
    {
        ...
        public static int MapLanguage(string language)
        {
            switch (language)
            {
                ...
                case Constants.LanguageCultures.English:
        ...
        public static string MapLanguageName(int language)
        {
            switch (language)
            {
                case (int)GeneralEnums.LanguageEnum.Arabic:
                    return Constants.LanguageCultures.Arabic;
                case (int)GeneralEnums.LanguageEnum.English:
                    return Constants.LanguageCultures.English;
                default:
                    return Constants.LanguageCultures.English;
            }
        }
        ...
        public static int GetCurrentLanguageId(IRequestCultureFeature requestCulture)
        {
            var selectedLang = requestCulture.RequestCulture.UICulture.Name;
            var languageId = CultureHelper.MapLanguage(selectedLang);
            return languageId;
        }
    }
}
