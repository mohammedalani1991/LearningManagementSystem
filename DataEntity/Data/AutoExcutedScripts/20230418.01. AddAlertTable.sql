...
ALTER TABLE [dbo].[EnrollStudentAlert]  WITH CHECK ADD  CONSTRAINT [FK_EnrollStudentAlert_Student] FOREIGN KEY([StudentId])
REFERENCES [dbo].[Student] ([Id])
ALTER TABLE [dbo].[EnrollStudentAlert] CHECK CONSTRAINT [FK_EnrollStudentAlert_Student]
