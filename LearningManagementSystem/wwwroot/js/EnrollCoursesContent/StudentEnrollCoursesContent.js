function Get() {
    var URL = "/Student/EnrollCoursesContent/GetData";
...
function ShowAddCoursesContent(langId) {
    ...
    $.ajax({
        type: "GET",
        url: "/Student/EnrollCoursesContent/ShowCreate/",
...
function ShowEditTable() {
    ...
    $.ajax({
        type: "GET",
        url: "/Student/EnrollCoursesContent/ShowTable/",
        success: function (data) {
            HideSpinner(); 
...
function ShowDetailsCoursesContent(id, langId) {
    ...
    $.ajax({
        type: "GET",
        url: "/Student/EnrollCoursesContent/ShowDetails/",
...
function ShowDeleteCoursesContent(id, langId,page) {
    ...
    $.ajax({
        type: "GET",
        url: "/Student/EnrollCoursesContent/ShowDelete/",
...
function ShowLecturesContent(id, langId, page) {
    ...
    $.ajax({
        type: "GET",
        url: "/Student/EnrollLecturesContent/ShowEdit/",
        data: { id: id, languageId: langId, page: page },
        success: function (data) {
            HideSpinner();
...
function ConfirmDelete(id,page) {
    ShowSpinner();
    $.post("/Student/EnrollCoursesContent/DeleteCoursesContent/",
        { id: id, page: page},
        function (data) {
            if (data !== null) {
                if (data == "Fail") {
...
function ShowEditCoursesContent(id, langId, page) {
    $.ajax({
        type: "GET",
        url: "/Student/EnrollCoursesContent/ShowEdit/",
        data: { id: id, languageId: langId, page:page },
        success: function (data) {
