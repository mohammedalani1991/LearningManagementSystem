function GetContent(id) {
    ...
    $.ajax({
        type: "GET",
        url: "/ControlPanel/EnrollCoursesContent/GetData",
        data: { courseId : $("#EnrollTeacherCourseId").val()},
        dataType: 'html',
...
function ShowAddCoursesContent(CourseId) {
    ShowSpinner();
    $.ajax({
        type: "GET",
        url: "/ControlPanel/EnrollCoursesContent/ShowCreate/",
        data: { enrollTeacherCourseId: CourseId },
        success: function (data) {
...
function ShowEditTable() {
    ...
    $.ajax({
        type: "GET",
        url: "/ControlPanel/EnrollCoursesContent/ShowTable/",
        success: function (data) {
            HideSpinner(); 
...
function ShowDetailsCoursesContent(id, langId) {
    ...
    $.ajax({
        type: "GET",
        url: "/ControlPanel/EnrollCoursesContent/ShowDetails/",
...
function ShowDeleteCoursesContent(id, langId,page) {
    ...
    $.ajax({
        type: "GET",
        url: "/ControlPanel/EnrollCoursesContent/ShowDelete/",
...
function ConfirmDelete(id,page) {
    ShowSpinner();
    $.post("/ControlPanel/EnrollCoursesContent/DeleteCoursesContent/",
        { id: id, page: page},
        function (data) {
            if (data !== null) {
                if (data == "Fail") {
...
function ShowEditCoursesContent(id, langId, page) {
    $.ajax({
        type: "GET",
        url: "/ControlPanel/EnrollCoursesContent/ShowEdit/",
        data: { id: id, languageId: langId, page:page },
        success: function (data) {
